    ...
    return (
        <div className="flex h-screen bg-background overflow-hidden font-sans">
                ...
                <nav className="flex-1 p-6 space-y-3">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 w-full px-4 py-3.5 rounded-xl font-bold transition-all ${activeTab === 'roaster'
                            ? 'bg-accent/10 text-accent scale-105 shadow-sm border border-accent/20'
                            : 'text-muted-foreground hover:bg-muted/50 hover:text-foreground'
                            }`}
                    >
            ...
            <nav className="md:hidden fixed bottom-0 w-full glass border-t border-border/50 flex justify-around items-center p-2 z-50">
                ...
                <button onClick={() => setActiveTab('roaster')} className={`p-2 rounded-xl flex flex-col items-center gap-1 flex-1 ${activeTab === 'roaster' ? 'text-accent' : 'text-muted-foreground'}`}>
